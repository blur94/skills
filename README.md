...
- **[audit-agent-instructions](./skills/engineering/audit-agent-instructions/SKILL.md)** — Audit and improve AGENTS.md and CLAUDE.md using project evidence, scope, and permission boundaries.
...
- **[init-repo-memory](./skills/engineering/init-repo-memory/SKILL.md)** — Initialize lean project memory, with optional handoff, decision, and multi-agent coordination files.
...
- **[write-task-prompt](./skills/productivity/write-task-prompt/SKILL.md)** — Draft reusable prompts for coding, research, writing, analysis, and operational work.
